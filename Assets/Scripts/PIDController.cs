...
public class PIDController : MonoBehaviour
{
	...
	public int[] rcCommand = { 0, 0, 0, 1330 };
	...
	private void apply()
	{
		...
		{
			int errorAngle = Mathf.Clamp(-_eularArray[axis], -500, 500);
	...
	{
		return rcCommand[3] + commandOffset[0] * x + commandOffset[1] * y + commandOffset[2] * z + commandOffset[3] + commandOffset[4];
	}
